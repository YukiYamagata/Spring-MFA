...
import com.example.demo.mfa.MFAAuthenticationConfigurer;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureGlobal(UserDetailsService userDetailsService, AuthenticationManagerBuilder auth) throws Exception {
		MFAAuthenticationConfigurer configurer = new MFAAuthenticationConfigurer(userDetailsService).passwordEncoder(passwordEncoder());
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/loginForm", "/account/**").permitAll()  // /loginFormは、全ユーザからのアクセスを許可
