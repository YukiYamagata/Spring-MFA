...
public class UserDaoImpl implements UserDao {
    ...
    public void save(MyUser user) {
        String sql = "INSERT INTO users(username, password, name, rolename, usemfa, secretkey) VALUES (?, ?, ?, ?, ?, ?)";
        jdbcTemplate.update(sql, user.getUserName(), user.getPassword(), user.getName(), user.getRoleName(), user.isUseMfa(), user.getSecretKey());
    }
